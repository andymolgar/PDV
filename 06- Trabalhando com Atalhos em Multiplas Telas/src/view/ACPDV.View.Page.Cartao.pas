...
type
  TframeCartao = class(TFrame)
    ...
    procedure pnlImgDebitoClick(Sender: TObject);
    procedure pnlImgCreditoClick(Sender: TObject);
    procedure imgMasterCardClick(Sender: TObject);
    procedure imgVisaClick(Sender: TObject);
    procedure imgDinnersClubClick(Sender: TObject);
    procedure imgAmericanExpressClick(Sender: TObject);
  private
...
procedure TframeCartao.imgAmericanExpressClick(Sender: TObject);
begin
  SetClick(shpAmericanExpress, pnlBandeiras);
end;

procedure TframeCartao.imgDinnersClubClick(Sender: TObject);
begin
  SetClick(shpDinnersClub, pnlBandeiras);
end;

procedure TframeCartao.imgMasterCardClick(Sender: TObject);
begin
  SetClick(shapeMasterCard, pnlBandeiras);
end;

procedure TframeCartao.imgVisaClick(Sender: TObject);
begin
  SetClick(shpVisa, pnlBandeiras);
end;
...
procedure TframeCartao.pnlImgCreditoClick(Sender: TObject);
begin
  SetClick(shapeCredito, pnlTipoCartao);
end;

procedure TframeCartao.pnlImgDebitoClick(Sender: TObject);
begin
  SetClick(shapeDebito, pnlTipoCartao);
end;
