...
begin
  ...
  begin
    ...
    TpageMensagem
      .New(self)
      .Mensagem(pnlMaster, 'O caixa deve estar aberto!', INFORMACAO)
  ...
  case Key of
    ...
    begin
      TpageMensagem
          .New(Self)
          .Mensagem(pnlMaster, 'Nenhuma balança configurada!', ERRO);
    end;
    ...
    begin
      ...
      dmDados.cdsItens.Open;

      if dmDados.cdsItens.IsEmpty then
      begin
        TpageMensagem
          .New(Self)
          .Mensagem(pnlMaster, 'Nenhum produto encontrado!', ERRO);
      ...
      TcomponenteListaItem
        ...
        .Item(FIndex)
        .Codigo(dmDados.cdsItenscodigo.AsString)
        ...
        lblPreco.Caption := FormatCurr('"R$ ",0.00', dmDados.cdsItensvalorunitario.AsCurrency );
        lblSubTotal.Caption := FormatCurr('"R$ ",0.00',
                dmDados.cdsItensvalorunitario.AsCurrency * StrToFloatDef(edtQuantidade.Text,1));

        FTotal := FTotal + (dmDados.cdsItensvalorunitario.AsCurrency * StrToFloatDef(edtQuantidade.Text,1));
